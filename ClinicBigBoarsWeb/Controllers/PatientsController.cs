...
namespace ClinicBigBoarsWeb.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public PatientsController(ClinicBigBoarsWebContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PatientId,Photo,Name,Surname,MiddleName,PassportNumSerial,Birthday,Gender,Address,PhoneNumber,EmailAddress,MedCardNum,MedCardDate,LastVizitDate,NextVizitDate,PolisNum,PolisDate,Diagnose,MedicalHistory")] Patient patient)
        {
